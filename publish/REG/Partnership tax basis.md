...
- basis in partnership interest adj each yr for their share of following items in order
	...
	- dec in basis
		- distributions
		- dec in partnership debt
		- loss/deduction items
- BASE
	- Beg capital acct (contributions)
	- A
		- additional contributions
...
- Tax Basis Limitation
	...
	- loss in excess of basis suspended until reinstated
	- basis can be reinstated by any of itmes inc basis, incl share of
		- ord business inc
		- sep stated inc/gain
		- additional contributions
		- inc in partnership debt
